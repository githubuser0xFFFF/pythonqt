...
void PythonQtWrapper_QMessageAuthenticationCode::addData(QMessageAuthenticationCode* theWrappedObject, const char*  data, qsizetype  length)
{
...
QMutexLocker* PythonQtWrapper_QMutexLocker::new_QMutexLocker(Mutex*  mutex)
{ 
return new QMutexLocker(mutex); }

bool  PythonQtWrapper_QMutexLocker::isLocked(QMutexLocker* theWrappedObject) const
{
  return ( theWrappedObject->isLocked());
}

Mutex*  PythonQtWrapper_QMutexLocker::mutex(QMutexLocker* theWrappedObject) const
{
...
void PythonQtWrapper_QMutexLocker::swap(QMutexLocker* theWrappedObject, QMutexLocker&  other)
{
  ( theWrappedObject->swap(other));
}
