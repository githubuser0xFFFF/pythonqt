...
qsizetype  PythonQtWrapper_QByteArrayMatcher::indexIn(QByteArrayMatcher* theWrappedObject, const char*  str, qsizetype  len, qsizetype  from) const
{
...
void PythonQtWrapper_QCryptographicHash::addData(QCryptographicHash* theWrappedObject, const char*  data, qsizetype  length)
{
