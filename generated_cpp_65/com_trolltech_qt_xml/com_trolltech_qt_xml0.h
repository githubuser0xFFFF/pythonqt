...
enum ParseOption{
  Default = QDomDocument::Default,   UseNamespaceProcessing = QDomDocument::UseNamespaceProcessing,   PreserveSpacingOnlyNodes = QDomDocument::PreserveSpacingOnlyNodes};
...
void delete_QXmlStreamAttributes(QXmlStreamAttributes* obj) { delete obj; }
   ...
   void swap(QXmlStreamAttributes* theWrappedObject, QList&  other);
   ...
   QXmlStreamAttribute  value(QXmlStreamAttributes* theWrappedObject, qsizetype  i) const;
