...
void delete_QXmlStreamAttributes(QXmlStreamAttributes* obj) { delete obj; }
   ...
   QStringView  value(QXmlStreamAttributes* theWrappedObject, const QString&  namespaceUri, const QString&  name) const;
   QStringView  value(QXmlStreamAttributes* theWrappedObject, const QString&  qualifiedName) const;
