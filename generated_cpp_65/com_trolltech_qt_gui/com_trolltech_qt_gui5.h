...
{ public:
inline QMouseEvent&  promoted_operator_assign(const QMouseEvent&  other) { return this->operator=(other); }
...
{ public:
inline QMoveEvent&  promoted_operator_assign(const QMoveEvent&  other) { return this->operator=(other); }
...
{ public:
inline QNativeGestureEvent&  promoted_operator_assign(const QNativeGestureEvent&  other) { return this->operator=(other); }
