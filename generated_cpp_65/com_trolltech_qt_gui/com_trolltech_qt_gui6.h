...
{ public:
inline QPaintEvent&  promoted_operator_assign(const QPaintEvent&  other) { return this->operator=(other); }
...
{ public:
inline QPlatformSurfaceEvent&  promoted_operator_assign(const QPlatformSurfaceEvent&  other) { return this->operator=(other); }
...
{ public:
inline QPointerEvent&  promoted_operator_assign(const QPointerEvent&  other) { return this->operator=(other); }
...
enum PointerType{
  Unknown = QPointingDevice::Unknown,   Generic = QPointingDevice::Generic,   Finger = QPointingDevice::Finger,   Pen = QPointingDevice::Pen,   Eraser = QPointingDevice::Eraser,   Cursor = QPointingDevice::Cursor,   AllPointerTypes = QPointingDevice::AllPointerTypes};
