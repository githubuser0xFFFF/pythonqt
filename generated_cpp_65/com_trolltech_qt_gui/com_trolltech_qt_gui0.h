...
{ public:
inline QActionEvent&  promoted_operator_assign(const QActionEvent&  other) { return this->operator=(other); }
...
{ public:
inline QCloseEvent&  promoted_operator_assign(const QCloseEvent&  other) { return this->operator=(other); }
