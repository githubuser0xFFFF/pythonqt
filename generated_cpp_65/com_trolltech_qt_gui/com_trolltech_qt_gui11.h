...
{ public:
inline QToolBarChangeEvent&  promoted_operator_assign(const QToolBarChangeEvent&  other) { return this->operator=(other); }
...
{ public:
inline QTouchEvent&  promoted_operator_assign(const QTouchEvent&  other) { return this->operator=(other); }
...
{ public:
inline QWhatsThisClickedEvent&  promoted_operator_assign(const QWhatsThisClickedEvent&  other) { return this->operator=(other); }
...
{ public:
inline QWheelEvent&  promoted_operator_assign(const QWheelEvent&  other) { return this->operator=(other); }
...
{ public:
inline QWindowStateChangeEvent&  promoted_operator_assign(const QWindowStateChangeEvent&  other) { return this->operator=(other); }
