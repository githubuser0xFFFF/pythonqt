...
void PythonQtWrapper_QGradient::setStops(QGradient* theWrappedObject, const QList<QPair<qreal , QColor >  >&  stops)
{
...
QList<QPair<qreal , QColor >  >  PythonQtWrapper_QGradient::stops(QGradient* theWrappedObject) const
{
