...
enum Capability{
  None = QInputDevice::None,   Position = QInputDevice::Position,   Area = QInputDevice::Area,   Pressure = QInputDevice::Pressure,   Velocity = QInputDevice::Velocity,   NormalizedPosition = QInputDevice::NormalizedPosition,   MouseEmulation = QInputDevice::MouseEmulation,   PixelScroll = QInputDevice::PixelScroll,   Scroll = QInputDevice::Scroll,   Hover = QInputDevice::Hover,   Rotation = QInputDevice::Rotation,   XTilt = QInputDevice::XTilt,   YTilt = QInputDevice::YTilt,   TangentialPressure = QInputDevice::TangentialPressure,   ZPosition = QInputDevice::ZPosition,   All = QInputDevice::All};
enum DeviceType{
  Unknown = QInputDevice::Unknown,   Mouse = QInputDevice::Mouse,   TouchScreen = QInputDevice::TouchScreen,   TouchPad = QInputDevice::TouchPad,   Puck = QInputDevice::Puck,   Stylus = QInputDevice::Stylus,   Airbrush = QInputDevice::Airbrush,   Keyboard = QInputDevice::Keyboard,   AllDevices = QInputDevice::AllDevices};
Q_DECLARE_FLAGS(Capabilities, Capability)
...
{ public:
inline QInputEvent&  promoted_operator_assign(const QInputEvent&  other) { return this->operator=(other); }
...
{ public:
inline QInputMethodEvent&  promoted_operator_assign(const QInputMethodEvent&  other) { return this->operator=(other); }
...
{ public:
inline QInputMethodQueryEvent&  promoted_operator_assign(const QInputMethodQueryEvent&  other) { return this->operator=(other); }
...
void delete_QItemSelection(QItemSelection* obj) { delete obj; }
   ...
   void swap(QItemSelection* theWrappedObject, QList&  other);
...
{ public:
inline QKeyEvent&  promoted_operator_assign(const QKeyEvent&  other) { return this->operator=(other); }
