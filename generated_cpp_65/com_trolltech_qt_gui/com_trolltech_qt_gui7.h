...
{ public:
inline QResizeEvent&  promoted_operator_assign(const QResizeEvent&  other) { return this->operator=(other); }
...
{ public:
inline QScreenOrientationChangeEvent&  promoted_operator_assign(const QScreenOrientationChangeEvent&  other) { return this->operator=(other); }
...
{ public:
inline QScrollEvent&  promoted_operator_assign(const QScrollEvent&  other) { return this->operator=(other); }
...
{ public:
inline QScrollPrepareEvent&  promoted_operator_assign(const QScrollPrepareEvent&  other) { return this->operator=(other); }
...
{ public:
inline QShortcutEvent&  promoted_operator_assign(const QShortcutEvent&  other) { return this->operator=(other); }
...
{ public:
inline QShowEvent&  promoted_operator_assign(const QShowEvent&  other) { return this->operator=(other); }
...
{ public:
inline QSinglePointEvent&  promoted_operator_assign(const QSinglePointEvent&  other) { return this->operator=(other); }
