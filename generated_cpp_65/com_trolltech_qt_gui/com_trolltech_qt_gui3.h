...
{ public:
inline QHelpEvent&  promoted_operator_assign(const QHelpEvent&  other) { return this->operator=(other); }
...
{ public:
inline QHideEvent&  promoted_operator_assign(const QHideEvent&  other) { return this->operator=(other); }
...
{ public:
inline QHoverEvent&  promoted_operator_assign(const QHoverEvent&  other) { return this->operator=(other); }
...
{ public:
inline QIconDragEvent&  promoted_operator_assign(const QIconDragEvent&  other) { return this->operator=(other); }
