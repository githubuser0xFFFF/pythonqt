...
void delete_QBitArray(QBitArray* obj) { delete obj; }
   ...
   bool  fill(QBitArray* theWrappedObject, bool  val, qsizetype  size = -1);
   ...
   QBitRef  operator_subscript(QBitArray* theWrappedObject, qsizetype  i);
   bool  operator_subscript(QBitArray* theWrappedObject, qsizetype  i) const;
...
QByteArray* new_QByteArray(const char*  arg__1, qsizetype  size = -1);
...
void delete_QByteArray(QByteArray* obj) { delete obj; }
   ...
   char*  erase(QByteArray* theWrappedObject, const char*  first, const char*  last);
   char*  erase(QByteArray* theWrappedObject, const char*  it);
   ...
   QByteArray*  insert(QByteArray* theWrappedObject, qsizetype  i, const char*  s);
   QByteArray*  insert(QByteArray* theWrappedObject, qsizetype  i, const char*  s, qsizetype  len);
   ...
   QByteArray  left(QByteArray* theWrappedObject, qsizetype  len) const;
   ...
   QByteArray*  prepend(QByteArray* theWrappedObject, const char*  s, qsizetype  len);
   ...
   QByteArray*  replace(QByteArray* theWrappedObject, const char*  before, qsizetype  bsize, const char*  after, qsizetype  asize);
   QByteArray*  replace(QByteArray* theWrappedObject, qsizetype  index, qsizetype  len, const char*  s, qsizetype  alen);
   ...
   QByteArray  right(QByteArray* theWrappedObject, qsizetype  len) const;
...
void delete_QDate(QDate* obj) { delete obj; }
   ...
   bool  __ne__(QDate* theWrappedObject, QDate  rhs);
   bool  __lt__(QDate* theWrappedObject, QDate  rhs);
   void writeTo(QDate* theWrappedObject, QDataStream&  arg__1);
   bool  __le__(QDate* theWrappedObject, QDate  rhs);
   bool  __eq__(QDate* theWrappedObject, QDate  rhs);
   bool  __gt__(QDate* theWrappedObject, QDate  rhs);
   bool  __ge__(QDate* theWrappedObject, QDate  rhs);
...
QDateTime* new_QDateTime(QDate  date, QTime  time, const QTimeZone&  timeZone);
...
void delete_QDateTime(QDateTime* obj) { delete obj; }
   ...
   void setDate(QDateTime* theWrappedObject, QDate  date);
   ...
   void setTime(QDateTime* theWrappedObject, QTime  time);
...
{ Q_OBJECT
public:
Q_ENUMS(Country CurrencySymbolFormat DataSizeFormat FloatingPointPrecisionOption FormatType Language LanguageCodeType MeasurementSystem NumberOption QuotationStyle Script )
...
enum WildcardConversionOption{
  DefaultWildcardConversion = QRegularExpression::DefaultWildcardConversion,   UnanchoredWildcardConversion = QRegularExpression::UnanchoredWildcardConversion};
...
void delete_QTime(QTime* obj) { delete obj; }
   ...
   bool  __ne__(QTime* theWrappedObject, QTime  rhs);
   bool  __lt__(QTime* theWrappedObject, QTime  rhs);
   void writeTo(QTime* theWrappedObject, QDataStream&  arg__1);
   bool  __le__(QTime* theWrappedObject, QTime  rhs);
   bool  __eq__(QTime* theWrappedObject, QTime  rhs);
   bool  __gt__(QTime* theWrappedObject, QTime  rhs);
   bool  __ge__(QTime* theWrappedObject, QTime  rhs);
