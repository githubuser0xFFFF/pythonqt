...
void delete_QDate(QDate* obj) { delete obj; }
   ...
   QDate  static_QDate_fromString(const QString&  string, const QString&  format, QCalendar  cal = QCalendar());
   ...
   QString  toString(QDate* theWrappedObject, const QString&  format, QCalendar  cal = QCalendar()) const;
...
void delete_QDateTime(QDateTime* obj) { delete obj; }
   ...
   QDateTime  static_QDateTime_fromString(const QString&  string, const QString&  format, QCalendar  cal = QCalendar());
   ...
   QString  toString(QDateTime* theWrappedObject, const QString&  format, QCalendar  cal = QCalendar()) const;
