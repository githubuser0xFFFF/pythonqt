...
void delete_QJSEngine(QJSEngine* obj) { delete obj; }
   ...
   QJSValue  evaluate(QJSEngine* theWrappedObject, const QString&  program, const QString&  fileName = QString(), int  lineNumber = 1, QStringList<QString >*  exceptionStackTrace = nullptr);
