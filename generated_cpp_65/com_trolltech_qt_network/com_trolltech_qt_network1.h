...
Q_FLAGS(SslOptions )
enum AlertLevel{
  Warning = QSsl::Warning,   Fatal = QSsl::Fatal,   Unknown = QSsl::Unknown};
enum AlertType{
  CloseNotify = QSsl::CloseNotify,   UnexpectedMessage = QSsl::UnexpectedMessage,   BadRecordMac = QSsl::BadRecordMac,   RecordOverflow = QSsl::RecordOverflow,   DecompressionFailure = QSsl::DecompressionFailure,   HandshakeFailure = QSsl::HandshakeFailure,   NoCertificate = QSsl::NoCertificate,   BadCertificate = QSsl::BadCertificate,   UnsupportedCertificate = QSsl::UnsupportedCertificate,   CertificateRevoked = QSsl::CertificateRevoked,   CertificateExpired = QSsl::CertificateExpired,   CertificateUnknown = QSsl::CertificateUnknown,   IllegalParameter = QSsl::IllegalParameter,   UnknownCa = QSsl::UnknownCa,   AccessDenied = QSsl::AccessDenied,   DecodeError = QSsl::DecodeError,   DecryptError = QSsl::DecryptError,   ExportRestriction = QSsl::ExportRestriction,   ProtocolVersion = QSsl::ProtocolVersion,   InsufficientSecurity = QSsl::InsufficientSecurity,   InternalError = QSsl::InternalError,   InappropriateFallback = QSsl::InappropriateFallback,   UserCancelled = QSsl::UserCancelled,   NoRenegotiation = QSsl::NoRenegotiation,   MissingExtension = QSsl::MissingExtension,   UnsupportedExtension = QSsl::UnsupportedExtension,   CertificateUnobtainable = QSsl::CertificateUnobtainable,   UnrecognizedName = QSsl::UnrecognizedName,   BadCertificateStatusResponse = QSsl::BadCertificateStatusResponse,   BadCertificateHashValue = QSsl::BadCertificateHashValue,   UnknownPskIdentity = QSsl::UnknownPskIdentity,   CertificateRequired = QSsl::CertificateRequired,   NoApplicationProtocol = QSsl::NoApplicationProtocol,   UnknownAlertMessage = QSsl::UnknownAlertMessage};
...
enum ImplementedClass{
  Key = QSsl::Key,   Certificate = QSsl::Certificate,   Socket = QSsl::Socket,   DiffieHellman = QSsl::DiffieHellman,   EllipticCurve = QSsl::EllipticCurve,   Dtls = QSsl::Dtls,   DtlsCookie = QSsl::DtlsCookie};
enum KeyAlgorithm{
...
enum SupportedFeature{
  CertificateVerification = QSsl::CertificateVerification,   ClientSideAlpn = QSsl::ClientSideAlpn,   ServerSideAlpn = QSsl::ServerSideAlpn,   Ocsp = QSsl::Ocsp,   Psk = QSsl::Psk,   SessionTicket = QSsl::SessionTicket,   Alerts = QSsl::Alerts};
...
enum PatternSyntax{
  RegularExpression = QSslCertificate::RegularExpression,   Wildcard = QSslCertificate::Wildcard,   FixedString = QSslCertificate::FixedString};
enum SubjectInfo{
...
void delete_QSslCertificate(QSslCertificate* obj) { delete obj; }
   ...
   QList<QSslCertificate >  static_QSslCertificate_fromPath(const QString&  path, QSsl::EncodingFormat  format = QSsl::Pem, QSslCertificate::PatternSyntax  syntax = PatternSyntax::FixedString);
